-- Fix order_items security vulnerability
...
-- 2) Drop the overly permissive policy that allows anyone to view all order items
DROP POLICY IF EXISTS "Users can view order items" ON public.order_items;

-- 3) Create restrictive RLS policies for order_items
